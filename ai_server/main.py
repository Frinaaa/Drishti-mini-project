...
Version: 4.1.0 (WebSocket Update)
Author: Drishti Team
"""
...
# --- CORS Configuration ---
# Allow all origins for development. In production, you might want to restrict this.
# CORRECTED version for development
app.add_middleware(
    CORSMiddleware,
...
async def root():
    ...
    return {
        ...
        "features": ["face_recognition", "live_websocket_streaming", "auto_database_updates"]
    }

@app.post("/find_match_react_native")
async def find_match_react_native(file_data: str = Form(...)):
    """Receives a single image from an app and performs a robust face search."""
    temp_file_path = None
    try:
...
async def websocket_live_stream(websocket: WebSocket):
    """
    Handles the live video streaming session with a mobile client.
...
if __name__ == "__main__":
    print("===========================================")
    print("🚀 Starting Drishti Face Recognition Service v4.1.0")
