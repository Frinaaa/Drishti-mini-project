// app/(family)/aboutUs.tsx

import React, { useState } from 'react';
// --- CHANGE: Added SafeAreaView for better layout on all devices ---
import { View, Text, StyleSheet, ScrollView, Image, TouchableOpacity, Modal, SafeAreaView } from 'react-native';
import { Ionicons } from '@expo/vector-icons';
// --- CHANGE: Imported Stack to control the screen's header ---
import { Stack } from 'expo-router';

// --- All the data for the page remains exactly the same ---
const officials = [
...
// It's good practice to give the component a slightly different name to avoid confusion.
export default function FamilyAboutUsScreen() {
  // --- All state and helper functions remain exactly the same ---
  ...
  return (
    // --- CHANGE: Wrapped the entire output in a SafeAreaView ---
    // This ensures content doesn't overlap with the phone's notch or home indicator.
    <SafeAreaView style={{ flex: 1, backgroundColor: '#FFFBF8' }}>
      {/* --- CHANGE: This is the key addition for navigation --- */}
      {/* This component tells Expo Router to render a header for this screen. */}
      {/* Because you are navigating to this screen from the Profile tab, */}
      {/* Expo Router will automatically add a back button to this header. */}
      <Stack.Screen options={{ title: 'About Drishti' }} />

      {/* The rest of the screen content is the same as before */}
      ...
      {/* The Modal for pop-ups remains the same */}
      <Modal
        animationType="fade"
        transparent={true}
...
// --- All styles are copied from the original file and remain the same ---
