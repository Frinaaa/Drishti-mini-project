...
export default function SubmitReportScreen() {
    ...
    // --- THIS IS THE FIX ---
    // We explicitly tell TypeScript that this state can be a 'string' OR 'null'.
    ...
    const handleImagePick = async () => {
        ...
        if (!result.canceled) {
            // Now, TypeScript knows that setting a 'string' here is valid.
    ...
    return (
        <>
            ...
            <ScrollView style={styles.container} contentContainerStyle={styles.scrollContent} keyboardShouldPersistTaps="handled">
                ...
                <Text style={styles.label}>Relation to Reporter</Text>
                <TextInput style={styles.input} value={relation} onChangeText={setRelation} placeholder="Select your relationship" placeholderTextColor="#b94e4e" />
...
const styles = StyleSheet.create({
    ...
    input: { backgroundColor: '#FFFFFF', borderWidth: 1, borderColor: '#E4C4C4', borderRadius: 12, padding: 14, fontSize: 16, marginBottom: 20, color: '#3A0000', justifyContent: 'center' },
